...
void SystemInit(void)
{
  ...
  /* - Configure I2C1 & I2C2 & USART1 clock with System Clock */
  RCC->CCIPR1 &= ~(RCC_CCIPR1_I2C1SEL_Msk |
		  	  	  RCC_CCIPR1_I2C2SEL_Msk |
				  RCC_CCIPR1_USART1SEL_Msk);
  RCC->CCIPR1 |=  (0b01 << RCC_CCIPR1_I2C1SEL_Pos |
		  	  	  0b01 << RCC_CCIPR1_I2C2SEL_Pos |
				  0b01 << RCC_CCIPR1_USART1SEL_Pos);
  ...
  /* - Configure PA9 & PA10 as USART1 alternate function in output push-pull */
  GPIOA->AFR[1] |=  (0x7<<GPIO_AFRH_AFSEL9_Pos |
		  	  	  0x7<<GPIO_AFRH_AFSEL10_Pos);
  ...
  /* - Configure I2C2 pins (PH4-SCL , PH5-SDA) */
  GPIOH->AFR[0] = (0x4<<GPIO_AFRL_AFSEL4_Pos |
		  	  	  0x4<<GPIO_AFRL_AFSEL5_Pos);
  GPIOH->OTYPER |= (GPIO_OTYPER_OT4 |
		  	  	  GPIO_OTYPER_OT5);
  GPIOH->MODER &= ~(GPIO_MODER_MODE4_Msk |
		  	  	  GPIO_MODER_MODE5_Msk);
  GPIOH->MODER |=  (GPIO_MODER_MODE4_1 |
		  	  	  GPIO_MODER_MODE5_1);
}
